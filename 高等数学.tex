...
\newcounter{G}[section]
\newcounter{H}[section]
\renewcommand{\thetheorem}{{\CJKfamily{heiti}定理} \textbf{\thechapter.\arabic{theorem}}}
\renewcommand{\thedefination}{{\CJKfamily{heiti}定义} \textbf{\thechapter.\arabic{defination}}}
\renewcommand{\theexample}{{\CJKfamily{heiti}题型} \textbf{\thechapter.\arabic{example}}}
\renewcommand{\theinference}{{\CJKfamily{heiti}方法} \textbf{\thechapter.\arabic{inference}}}
...
\newcommand{\solveother}{\vspace*{1em} \noindent  \hspace*{0.2em}  \tcbox[colframe =black, colback =black!10!white,boxrule=0.5mm,size=small,on line]{\color{black}{{\CJKfamily{heiti}另解}}}\hspace{1.5em}}
...
\newcommand{\simpleexamples}{ \noindent  \tcbox[colframe =ex, colback =ex!10!white,boxrule=0.5mm,size=small,on line]{\CJKfamily{heiti} \color{ex}{例}}\hspace{1.5em}}
...
\newcommand{\warn}[1][]{
	\vspace*{0.5em}
	\begin{tcolorbox}[colframe=red!75!black, colback=yellow!10!white,title=注意,fonttitle =\CJKfamily{heiti}]
		#1
\end{tcolorbox}}
\newcommand{\summarize}[1][]{
	\vspace*{0.5em}
	\begin{tcolorbox}[colframe=white!20!black, colback=white!95!black,title=评注,fonttitle =\CJKfamily{heiti}]
		#1
\end{tcolorbox}}

%文本高亮
\newcommand{\highlights}[1][]{\tcbox[colframe =Chocolate , colback =Coral,boxrule=0.5mm,size=small,on line]{\color{white}{\CJKfamily{heiti}#1}}}
