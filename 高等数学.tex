...
\newcounter{G}[section]
\newcounter{H}[section]
\renewcommand{\thetheorem}{{\CJKfamily{heiti}定理} \textbf{\thesection.\arabic{theorem}}}
\renewcommand{\thedefination}{{\CJKfamily{heiti}定义} \textbf{\thesection.\arabic{defination}}}
\renewcommand{\theexample}{{\CJKfamily{heiti}题型} \textbf{\thechapter.\arabic{example}}}
\renewcommand{\theinference}{{\CJKfamily{heiti}方法} \textbf{\thesection.\arabic{inference}}}
\renewcommand{\theexamples}{{\CJKfamily{heiti}例}  \textbf{\thechapter.\arabic{examples}}}
\renewcommand{\thetl}{{\CJKfamily{heiti}推论}  \textbf{\thechapter.\arabic{tl}}}
...
%定理类
\newcommand{\theorem}[1][]{\vspace{1em}\s \refstepcounter{theorem}\label{#1} \mybox[dl]{\color{dl}\thetheorem\hspace{1em}#1}\vspace{0.5em}  \par}
...
\newcommand{\ttheorem}[1][]{\s \refstepcounter{theorem}\label{#1} \mybox[dl]{\color{dl}\thetheorem\hspace{1em}#1} \vspace*{-1em}\par }
...
%推论类
\newcommand{\inference}[1][]{\vspace{1em}\s \refstepcounter{inference}\label{#1} \mybox[inference]{\color{inference}\theinference\hspace{1em}#1}\vspace{0.5em}   \par}
\newcommand{\enupinference}[1][]{\vspace{1em}\s \refstepcounter{inference}\label{#1} \mybox[inference]{\color{inference}\theinference\hspace{1em}#1}\vspace*{-0.8cm}  }
\newcommand{\enbelowinference}[1][]{\hspace*{-1.5em}\s \refstepcounter{inference}\label{#1} \mybox[inference]{\color{inference}\theinference\hspace{1em}#1}  \par}
...
%定义类
\newcommand{\defination}[1][]{\vspace{1em}\s \refstepcounter{defination}\label{#1} \mybox[dy0]{\color{dy0}\thedefination\hspace{1em}#1}\vspace{0.5em} \par}
...
\newcommand{\tdefination}[1][]{   \s \refstepcounter{defination}\label{#1} \mybox[dy0]{\color{dy0}\thedefination\hspace{1em}#1}\vspace*{0.5em}  \par }
...
\newcommand{\texample}[1][]{  \s \refstepcounter{example} \mybox[ex]{\color{ex}\theexample\hspace{1em}#1} \vspace*{-1em} \par }
...
\def\degree{{}^{\circ}}
\newcommand{\examples}{\vspace*{1em}\noindent  \refstepcounter{examples} \tcbox[colframe =ex, colback =ex!10!white,boxrule=0.5mm,size=small,on line]{\color{ex}{\theexamples}}\hspace{1.5em}}
\newcommand{\tl}{\vspace*{1em}\noindent \refstepcounter{tl} \tcbox[colframe =tl, colback =tl!10!white,boxrule=0.5mm,size=small,on line]{\color{tl}{\thetl}}\hspace{1.5em}}
\newcommand{\proof}{\vspace*{1em} \noindent  \hspace*{0.2em}  \tcbox[colframe =black, colback =black!10!white,boxrule=0.5mm,size=small,on line]{\color{black}{{\CJKfamily{heiti}证}}}\hspace{1.5em}}
\newcommand{\solve}{\vspace*{1em} \noindent  \hspace*{0.2em}  \tcbox[colframe =black, colback =black!10!white,boxrule=0.5mm,size=small,on line]{\color{black}{{\CJKfamily{heiti}解}}}\hspace{1.5em}}
\newcommand{\errsolve}{\vspace*{1em} \noindent  \hspace*{0.2em}  \tcbox[colframe =red, colback =red!10!white,boxrule=0.5mm,size=small,on line]{\color{red}{{\CJKfamily{heiti}错解}}}\hspace{1.5em}}
\newcommand{\errreason}{\vspace*{1em} \noindent  \hspace*{0.2em}  \tcbox[colframe =red, colback =red!10!white,boxrule=0.5mm,size=small,on line]{\color{red}{{\CJKfamily{heiti}错因}}}\hspace{1.5em}}
\newcommand{\solvereason}{\vspace*{1em} \noindent  \hspace*{0.2em}  \tcbox[colframe =ForestGreen
, colback =ForestGreen!15!white,boxrule=0.5mm,size=small,on line]{\color{ForestGreen}{{\CJKfamily{heiti}解析}}}\hspace{1.5em}}
