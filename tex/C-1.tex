...
如果$x_0$是函数$f(x)$的间断点,但左极限$f(x_0^-)$和右极限$f(x_0^+)$都存在,那么点$x_0$就称为函数$f(x)$的\dy[第一类间断点]{DYLJDD},不是第一类间断点的任何间断点都是\dy[第二类间断点]{DELJDD}.常见的具体分类间下表\ref{函数间断点的分类}.
\begin{table}[!htb]
	\centering
...
\kg 进一步说,如果函数$f(x)$的导函数是$f'(x)$,点$x_$
]
